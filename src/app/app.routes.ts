...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'student-registration/:id', component: AdminRegistrationComponent, title: 'Registration' },
            ...
            { path: 'lesson-create/:id', component: LessonCreateComponent, title: 'Lesson Create' },
